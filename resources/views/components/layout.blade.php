<x-head class="d-flex font-sans h-screen">
    <div class="bg-primary h" id="sidebar">
        <div class="px-4">
            {{-- <div class="container d-flex justify-content-center my-3"> --}}
            <div class="my-3">
                <div class="d-flex justify-content-between align-items-center">
                    <div><img src="{{ asset('static/mlgcl_logo.png') }}" height="100" alt="">
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="enrollment-accordion-links">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#enrollment-links" aria-expanded="false"
                                aria-controls="enrollment-links">
                                Enrollments
                            </button>
                        </h2>
                        <div id="enrollment-links" class="accordion-collapse collapse"
                            aria-labelledby="enrollment-accordion-links" data-bs-parent="#enrollment-accordion">
